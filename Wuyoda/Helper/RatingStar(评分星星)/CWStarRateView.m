...
#define FOREGROUND_STAR_IMAGE_NAME @"foreStarImg"
#define BACKGROUND_STAR_IMAGE_NAME @"backStarImg"
#define DEFALUT_STAR_NUMBER 3
...
- (void)buildDataAndUI {
    ...
    _allowIncompleteStar = NO;//默认为NO 是否允许半星
...
- (UIView *)createStarViewWithImage:(NSString *)imageName {
    ...
    for (NSInteger i = 0; i < self.numberOfStars; i ++)
    {
        ...
        imageView.frame = CGRectMake(i * self.bounds.size.width / self.numberOfStars, 0, self.bounds.size.height, self.bounds.size.height);
