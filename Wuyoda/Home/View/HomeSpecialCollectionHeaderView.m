//
//  HomeSpecialCollectionHeaderView.m
//  Wuyoda
//
...
@interface HomeSpecialCollectionHeaderView ()
...
@implementation HomeSpecialCollectionHeaderView
...
-(void)createUI{
    UIView *bgV = [[UIView alloc]initWithFrame:CGRectMake(kWidth(20), 0, kWidth(335), kWidth(413))];
    ...
    self.imgV = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, kWidth(335), kWidth(335))];
    ...
    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(productDetailClicked)];
